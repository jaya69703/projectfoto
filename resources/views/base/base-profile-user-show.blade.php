...
@section('content')
    <div class="layout-top-spacing">
        @if(Route::is('admin.usermanage.show'))
        <form action="{{ route('admin.usermanage.update-member', $user->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          <div class="row">
                                    ...
                                    <div class="tab-pane fade show active" id="rounded-pills-icon-home" role="tabpanel" aria-labelledby="rounded-pills-icon-home-tab">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6 col-12 mb-2">
                                                ...
                                                <input type="text" disabled id="code" name="code" class="form-control" value="{{ $user->code }}">
