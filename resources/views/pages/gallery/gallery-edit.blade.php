                        ...
                        <div class="form-group mb-2">
                            <div class="text-center">
                                ...
                                <img src="{{ asset('storage/' . $gallery->cover) }}"
                                    class="card-img-top img-fluid text-center mb-2" style="width: 450px;"
                                    alt="Image-Picture" id="cover-preview">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="row card-body">
                            ...
                            <select name="cpaket_id" id="cpaket_id" class="form-select">
                                ...
                                @foreach ($cpaket as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $item->id == $gallery->cpaket_id ? 'selected' : '' }}>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('cpaket_id')
                        ...
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <select name="paket_id" id="paket_id" class="form-select">
                                ...
                                @foreach ($paket as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $item->id == $gallery->paket_id ? 'selected' : '' }}>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('paket_id')
                        ...
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Input your name..." value="{{ $gallery->name }}">
                        ...
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <input type="file" name="image_1" id="image_1" class="form-control"
                                placeholder="Input your image..." value="{{ $gallery->image_1 }}">
                            @error('image_1')
                                <small class="text-center">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <input type="file" name="image_2" id="image_2" class="form-control"
                                placeholder="Input your image..." value="{{ $gallery->image_2 }}">
                            @error('image_2')
                                <small class="text-center">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <input type="file" name="image_3" id="image_3" class="form-control"
                                placeholder="Input your image..." value="{{ $gallery->image_3 }}">
                            @error('image_3')
                                <small class="text-center">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <input type="file" name="image_4" id="image_4" class="form-control"
                                placeholder="Input your image..." value="{{ $gallery->image_4 }}">
                            @error('image_4')
                                <small class="text-center">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-12 mb-2">
                            ...
                            <input type="file" name="image_5" id="image_5" class="form-control"
                                placeholder="Input your image..." value="{{ $gallery->image_5 }}">
                            @error('image_5')
                                <small class="text-center">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-lg-12 col-12 mb-2">
                            ...
                            <textarea name="desc" id="desc" cols="30" rows="10" class="form-control"
                                placeholder="Input your gallery description..." value="{{ $gallery->desc }}">{{ $gallery->desc }}</textarea>
                            @error('desc')
                                <small class="text-center">{{ $message }}</small>
                            @enderror
                        </div>
    ...
    <script>
        ...
        function showPreview(file) {
            if (file) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    const preview = document.querySelector(`[data-for="${file.name}"`);
                    preview.src = e.target.result;
                    preview.style.display = 'block'; // Menampilkan tag img saat gambar tersedia
                };
                reader.readAsDataURL(file);
            }
        }
