    ...
    <div class="col-lg-12 mb-3">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span class="text" style="font-size: 20px;">Daftar Postingan</span>
                <span class="icon">
                    {{-- <button type="submit" class="btn btn-outline-success btn-rounded"><i class="fa-solid fa-plus"></i></button> --}}
                    <a href="{{ route('author.blog.post-create') }}" class="btn btn-outline-primary btn-rounded"><i class="fa-solid fa-plus"></i></a>
