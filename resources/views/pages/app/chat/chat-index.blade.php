...
@section('custom-css')
<link href="{{ asset('main') }}/src/assets/css/light/apps/chat.css" rel="stylesheet" type="text/css" />
<link href="{{ asset('main') }}/src/assets/css/dark/apps/chat.css" rel="stylesheet" type="text/css" />
@endsection
@section('content')
                    ...
                    <div class="chat-system">
                        ...
                        <div class="user-list-box">
                            ...
                            <div class="people">
                                ...
                                @php $person = App\Models\User::all()  @endphp
                                @foreach ($person as $key => $item)

                                <div class="person" data-chat="person{{$item->id}}" data-receiver="{{$item->id}}">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{ asset('storage/images/user/'.$item->image) }}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                                <span class="user-name" data-name="{{ $item->name }}">{{ $item->name }}</span>
                                ...
                                <div class="person border-none" data-chat="person12">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{ asset('main') }}/src/assets/img/profile-20.jpeg" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                        ...
                        <div class="chat-box">
                            ...
                            <div class="chat-box-inner">
                                <div class="chat-meta-user">
                                    <div class="current-chat-user-name"><span><img src="{{ asset('main') }}/src/assets/img/90x90.jpg" alt="dynamic-image"><span class="name"></span></span></div>
                                ...
                                <div class="chat-conversation-box">
                                    <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                        ...
                                        <div class="chat" data-chat="person{{$item->sender_id}}">
                                            <div class="conversation-start">
                                                <span>{{ $item->created_at->diffForHumans() }}</span>
                                            </div>
                                            @if($item->sender_id == Auth::user()->id) {{-- Ubah $loggedInUserId sesuai dengan variabel yang menyimpan ID pengguna yang sedang login --}}
                                ...
                                <div class="chat-footer">
                                    <div class="chat-input">
                                        <form action="{{ route('admin.chat.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input id="message" name="message" type="text" class="mail-write-box form-control" placeholder="Message"/>
...
@endsection
@section('custom-js')
<script src="{{ asset('main') }}/src/assets/js/apps/chat.js"></script>
<!-- Pastikan Anda sudah menyertakan jQuery di template Anda -->
{{-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> --}}
<script>
    $(document).ready(function(){
    const users = document.querySelectorAll('.person');
    const receiverIdInput = $('#receiverId'); // Select input element

    users.forEach(user => {
        user.addEventListener('click', () => {
            const receiverId = user.getAttribute('data-receiver'); // Get receiver id
            receiverIdInput.val(receiverId); // Set the value of hidden input
        });
    });
