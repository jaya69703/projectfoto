...
@section('content')
  ...
  <section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item" style="background-image: url({{ asset('root') }}/assets/img/hero-carousel/bg-1.jpg)"></div>
      <div class="carousel-item" style="background-image: url({{ asset('root') }}/assets/img/hero-carousel/bg-2.jpg)"></div>
      <div class="carousel-item" style="background-image: url({{ asset('root') }}/assets/img/hero-carousel/bg-3.jpg)"></div>
      <div class="carousel-item active" style="background-image: url({{ asset('root') }}/assets/img/hero-carousel/bg-4.jpg)"></div>
      <div class="carousel-item" style="background-image: url({{ asset('root') }}/assets/img/hero-carousel/bg-5.jpg)"></div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
          ...
          <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-terbaru">
              <div class="portfolio-content h-100">
                <img src="{{ asset('storage/images/paket/'.$item->image) }}" class="img-fluid rounded" alt="">
                <div class="portfolio-info">
                  <h4>{{ $item->price }}</h4>
                  <p>{{  $item->name }}</p>
                  <a href="{{ asset('storage/images/paket/'.$item->image) }}" title="{{ $item->description }}" data-gallery="portfolio-gallery-terbaru" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="{{ route('root.pages.pdetails',$item->id) }}" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div>
